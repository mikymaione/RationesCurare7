...
namespace RationesCurare7.UI.Forms
{
    public partial class fInserimento : fMyForm
    {
        ...
        public string Tipo
        {
            ...
            set
            {
                var z = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(value);
                lCassa.Text = z;
                Tipo_ = value;
            }
        }
        ...
        {
            var r = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(TipoGiroconto_);
            lCassaGiroconto.Text = $"{r}: {cGB.DoubleToMoneyStringValuta(eSoldi.Value * -1)}";

            var l = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(Tipo_);
